    ...
    return (
        <>
            <GridForm
                ...
                setFilter={setFilter}
                className="lg:col-9"
                add="/depreciation/add?type=3"
                addName="Thêm chi phí chung"
            ...
            >
                <p className="m-0">
                    {visible && <UpdatePhanBoKhauHao type={3} onClose={handleModalClose} ></UpdatePhanBoKhauHao>}
                </p>
            </Dialog>
        </>
...
export default function ListChiPhiChung() {
            ...
            />
             <div style={{ height: 'calc(100vh - 8rem)' }}>
                ...
                >
                    ...
                    >
                        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
                            <b>Phân bổ khấu hao chi phí chung</b>
                            <DataTableClient
                                rowHover
