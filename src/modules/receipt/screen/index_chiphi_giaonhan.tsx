...
import { deleteMultiDebit } from "modules/Debit/api";

// ✅ Component Header lọc dữ liệu
const Header = ({ _setParamsPaginator, _paramsPaginator, selected, onClose}: any) => {
    ...
    return (
      <>
       <GridForm
        ...
        >
            <p className="m-0">
              {selected && <UpdateHoanUngGiaoNhan debits={selected} onClose={handleModalClose} employeeId={filter.employeeId}  fromDate={filter.fromDate} toDate={filter.toDate}  ></UpdateHoanUngGiaoNhan>}
            </p>
        </Dialog>
      </>
...
export default function ListChiPhiGiaoNhan() {
    ...
    return (
      <>
        <div className="card">
            <Header _paramsPaginator={paramsPaginator} _setParamsPaginator={setParamsPaginator} selected={selectedDebitServiceRows} onClose={handleModalClose} />
