...
export default function UpdatePhieuChiNCC({debits, supplierDetailId, onClose}: {debits: any, supplierDetailId: string, onClose: () => void }) {
  ...
  const handleSubmit = (e: any) => {
    ...
    infos.amount = amount;
    infos.ObjectId = supplierDetailId;
    infos.Object = 1;
    let info = {
      ...infos,
