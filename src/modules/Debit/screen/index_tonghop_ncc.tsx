...
import { useListDebitCongNoTongHopNCC } from "../service";
...
export default function ListTongHopNCC() {
  ...
  const { data, loading, error, refresh } = useListDebitCongNoTongHopNCC({
