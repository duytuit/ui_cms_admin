...
export const listDataShareDepartment = async (params: any) => await getData("DataShare/departments", params);
export const listDataShareEmployee = async (params: any) => await getData("DataShare/employees", params);
export const showDataShareEmployeeByCycleName = async (params: any) => await getData("DataShare/GetByCycleName", params);
